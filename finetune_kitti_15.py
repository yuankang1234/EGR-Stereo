...
parser.add_argument('--datapath', default="/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/kitti2015/", help='data path')
parser.add_argument('--trainlist', default="./filenames_1/kitti15_train_200.txt", help='training list')
parser.add_argument('--testlist', default="./filenames_1/kitti15_val_40.txt", help='testing list')
...
parser.add_argument('--lrepochs', type=str, default="100,600,1500:2", help='the epochs to decay lr: the downscale rate')

parser.add_argument('--logdir', default="./finetune_15", help='the directory to save logs and checkpoints')
parser.add_argument('--loadckpt', default="./finetune_12_15/checkpoint_001199.ckpt",
...
def train():
    ...
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        if epoch_idx > 1600:
            ...
            train_log_yk = open("tf_log_kitti_15.txt", mode="a", encoding="utf-8")
