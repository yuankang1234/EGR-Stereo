...
parser.add_argument('--model', default='cfnet-gc', help='select a model structure', choices=__models__.keys())
...
parser.add_argument('--lrepochs', type=str, default="10:2", help='the epochs to decay lr: the downscale rate')
