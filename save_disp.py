...
parser.add_argument('--testlist', default="./filenames_1/kitti15_test.txt", help='testing list')
parser.add_argument('--loadckpt', default="./finetune_15/checkpoint_001966.ckpt", help='load the weights from a specific checkpoint')
...
def test():
    os.makedirs('./pre_train_230918', exist_ok=True)
    for batch_idx, sample in enumerate(TestImgLoader):
        ...
        for disp_est, top_pad, right_pad, fn in zip(disp_est_np, top_pad_np, right_pad_np, left_filenames):
            ...
            fn = os.path.join("./pre_train_230918/", fn.split('/')[-1])
