...
parser.add_argument('--datapath', default="/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/kitti12_15_all/", help='data path')
parser.add_argument('--trainlist', default="./filenames_1/kitti12_15_all.txt", help='training list')
parser.add_argument('--testlist', default="./filenames_1/kitti12_15_val.txt", help='testing list')
...
parser.add_argument('--lrepochs', type=str, default="10:10", help='the epochs to decay lr: the downscale rate')

parser.add_argument('--logdir', default="./finetune_12_15", help='the directory to save logs and checkpoints')
parser.add_argument('--loadckpt', default="./finetune_12_15/checkpoint_000817.ckpt",
...
def find_bottom_4(lst):
    ...
    # 返回前6个元素的值和下标
    bottom_4_values = [x[1] for x in sorted_lst[:50]]
    bottom_4_indices = [x[0] for x in sorted_lst[:50]]
...
def train():
    ...
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        if epoch_idx > 1600:
            ...
            train_log_yk = open("tf_log_kitti12_and_15.txt", mode="a", encoding="utf-8")
            ...
            gc.collect()
    bottom_loss_values, bottom_loss_indices = find_bottom_4(loss_list)  # 看上去是4,其实是50个
