...
parser.add_argument('--trainlist', default="./filenames_1/kitti12_train_194.txt", help='training list')
parser.add_argument('--testlist', default="./filenames_1/kitti12_val_last60.txt", help='testing list')
...
parser.add_argument('--logdir', default="./finetune_12", help='the directory to save logs and checkpoints')
...
def train():
    ...
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        if epoch_idx > 1600:
            ...
            train_log_yk = open("tf_log_kitti_12.txt", mode="a", encoding="utf-8")
